...
INSERT INTO Summoner(id, level, rank, money) VALUES
('Rookie', 10, 'Gold', 5000),
...
INSERT INTO GameMode(name, description) VALUES
('Ultra Rapid Fire', 'no cooldown'),
...
INSERT INTO NonPlayerCharacter(name, health) VALUES
('monsterA', 1200),
('monsterB', 3000),
('monsterC', 1500),
('monsterD', 1200),
...
INSERT INTO Monster(name, buff, type) VALUES
('monsterA', 'Damage Boost', 'Dragon'),
...
INSERT INTO Minion(name, side, type) VALUES
('minion1', 'Blue', 'Melee'),
('minion2', 'Blue', 'Caster'),
('minion3', 'Red', 'Melee'),
('minion4', 'Red', 'Caster'),
...
INSERT INTO Turret(name, position) VALUES
('turret1', 'Top Lane outer'),
...
INSERT INTO SelectFavorite(id, name) VALUES
('Rookie', 'Ultra Rapid Fire'),
('Rookie', 'One for All'),
...
INSERT INTO LearnAbout(id, name) VALUES
('Rookie','monsterA'),
('Uzi','monsterB'),
('Lwx','monsterC'),
('Caps','monsterD'),
...
INSERT INTO EpithetBackground(epithet, background story) VALUES
('The Unforgiven', 'The story of a sword is inked in blood'),
...
INSERT INTO championBCNF(name,cost,region,epithet) VALUES
('Yasuo', '4800', 'Ionia','The Unforgiven'),
...
INSERT INTO StatisticProduced(id,name,type,value) VALUES
('Uzi', 'Yasuo', 'Kills', '12'),
('Uzi', 'Yasuo', 'Assists', '7'),
('Uzi', 'Yasuo', 'Deads', '5'),
...
INSERT INTO StoreVisit(storeID, promotion, id) VALUES
('store 1', '20% off', 'Uzi'),
...
INSERT INTO Sell1(name, storeID) VALUES
('Yasuo', 'store 1'),
('Riven', 'store 2'),
('Thresh', 'store 3'),
('Amumu', 'store 4'),
...
INSERT INTO Sell2(name, storeID) VALUES
('PROJECT', 'store 1'),
...
INSERT INTO TypeCost(type, cost) VALUES
('Ultimate', '3250'),
('Legendary', '1820'),
('Mythic', '2000'),
('Standard', '975'),
...
INSERT INTO SkinDecorateBCNF(skin-name, type, champion-name) VALUES
('PROJECT', 'Epic', 'Yasuo'),
...
INSERT INTO AbilityOwned(ability-name, cooldown, key, description, champion-name) VALUES
('WAY OF THE WANDERER','60','P','Passive ability','Yasuo'),
